  ...
  methods: {
    ...
    init() {
      this.$store.dispatch('team/team', this.$route.params.id).then(() => {
        ...
        this.ruleForm.leader = this.getTeamMember(this.$store.getters['team/teamId'] ? this.$store.getters['team/teamId'] : null, this.constants('LEADER'));
        this.ruleForm.members = this.getTeamMember(this.$store.getters['team/teamId'] ? this.$store.getters['team/teamId'] : [], this.constants('MEMBER'));
        this.ruleForm.observe = this.getTeamMember(this.$store.getters['team/teamId'] ? this.$store.getters['team/teamId'] : [], this.constants('OBSERVE'));
      });
    },
    resetForm(formName) {
